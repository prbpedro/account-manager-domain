...
* The sender's account must have been found to do the transfer
* Currency must exist
* Transferred value must be positive and scaled to 19 accuracy to 2. (Database limitations)
...
The unit testing code coverage report is available in the $PROJECT_FOLDER/target/site/jacoco/index.html file generated through the Maven jacoco-maven-plugin.
The project documentation is available in the $PROJECT_FOLDER/target/apidocs/index.html file generated by the Maven maven-javadoc-plugin plugin and is attacked by the Maven-generated JAR.
