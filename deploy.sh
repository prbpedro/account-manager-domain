...
git config user.email "prbpedro@gmail.com"
...
git push --force --quiet "https://$da17905eb3e4804649d99d090e30e3393f812c84@$https://github.com/prbpedro/account-manager-domain" master:gh-pages > /dev/null 2>&1
