...
public class TransactionValidationServiceTest {
	...
	public void testInexistentCurrency() throws SQLException {
		TransferTransactionalDataDto ret = transactionValidationService.validateTransfer("ACCOUNT_999", "ACCOUNT_9999",
				"XXX", "XXX", BigDecimal.ONE, null);
		Assert.assertEquals(TransferTransactionStatusEnum.NOT_FOUND, ret.getReturnDto().getStatus());
	...
	public void testInexistentSenderAccount() throws SQLException {
		TransferTransactionalDataDto ret = transactionValidationService.validateTransfer("ACCOUNT_999", "ACCOUNT_9999",
				Constants.REVOLUT_BANK_CODE, Constants.BRL, BigDecimal.ONE, null);
		Assert.assertEquals(TransferTransactionStatusEnum.NOT_FOUND, ret.getReturnDto().getStatus());
	...
	public void testInexistentBeneficiaryBank() throws SQLException {
		TransferTransactionalDataDto ret = transactionValidationService.validateTransfer("ACCOUNT_1", "ACCOUNT_9999",
				"XXX", Constants.USD, BigDecimal.ONE, null);
		Assert.assertEquals(TransferTransactionStatusEnum.NOT_PROCESSED, ret.getReturnDto().getStatus());
	...
	public void testOtherBeneficiaryBank() throws SQLException {
		TransferTransactionalDataDto ret = transactionValidationService.validateTransfer("ACCOUNT_1", "ACCOUNT_9999",
				Constants.BORINGBANK, Constants.USD, BigDecimal.ONE, null);
		Assert.assertEquals(TransferTransactionStatusEnum.NOT_PROCESSED, ret.getReturnDto().getStatus());
		Assert.assertEquals(Constants.OPERATION_NOT_SUPPORTED, ret.getReturnDto().getMessages().get(0));
	}
	...
	public void testInexistentBeneficiaryAccount() throws SQLException {
		TransferTransactionalDataDto ret = transactionValidationService.validateTransfer("ACCOUNT_1", "ACCOUNT_9999",
				Constants.REVOLUT_BANK_CODE, Constants.USD, BigDecimal.ONE, null);
		Assert.assertEquals(TransferTransactionStatusEnum.NOT_FOUND, ret.getReturnDto().getStatus());
		Assert.assertEquals("Beneficiary's account doesn't exists.", ret.getReturnDto().getMessages().get(0));
	}

	@Test
	public void testTransferInexistentBeneficiaryAccountBallance() throws SQLException {
		TransferTransactionalDataDto ret = transactionValidationService.validateTransfer("ACCOUNT_1", "ACCOUNT_9999",
				Constants.REVOLUT_BANK_CODE, Constants.USD, BigDecimal.ONE, null);
		Assert.assertEquals(TransferTransactionStatusEnum.NOT_FOUND, ret.getReturnDto().getStatus());
		Assert.assertEquals("Beneficiary's account doesn't exists.", ret.getReturnDto().getMessages().get(0));
	...
	@Test
	public void testTransferInactiveSenderAccount() throws SQLException {
		TransferTransactionalDataDto ret = transactionValidationService.validateTransfer("ACCOUNT_9", "ACCOUNT_9999",
				Constants.REVOLUT_BANK_CODE, Constants.USD, BigDecimal.ONE, null);
		Assert.assertEquals(TransferTransactionStatusEnum.NOT_FOUND, ret.getReturnDto().getStatus());
		Assert.assertEquals("Sender's account doesn't exists.", ret.getReturnDto().getMessages().get(0));
	}
